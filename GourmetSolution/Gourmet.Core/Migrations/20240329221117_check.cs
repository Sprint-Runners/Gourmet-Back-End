        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecentFoods = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FavouritFoods = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Foods_CMs_Cooking_MethodId",
                        column: x => x.Cooking_MethodId,
                        principalTable: "CMs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Foods_FTs_Food_typeId",
                        column: x => x.Food_typeId,
                        principalTable: "FTs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Foods_MTs_Meal_Type",
                        column: x => x.Meal_Type,
                        principalTable: "MTs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Foods_Ns_NationalityId",
                        column: x => x.NationalityId,
                        principalTable: "Ns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Foods_PSOIs_Primary_Source_of_IngredientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodIngredients", x => new { x.RecipeId, x.IngredientId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Foods_Cooking_MethodId",
                table: "Foods",
                column: "Cooking_MethodId");

            migrationBuilder.CreateIndex(
                name: "IX_Foods_Food_typeId",
                table: "Foods",
                column: "Food_typeId");

            migrationBuilder.CreateIndex(
                name: "IX_Foods_Meal_Type",
                table: "Foods",
                column: "Meal_Type");

            migrationBuilder.CreateIndex(
                name: "IX_Foods_NationalityId",
                table: "Foods",
                column: "NationalityId");

            migrationBuilder.CreateIndex(
                name: "IX_Foods_Primary_Source_of_IngredientId",
                table: "Foods",
