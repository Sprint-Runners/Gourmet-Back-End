...
namespace Gourmet.Core.Services
{
    public class JWTService : IJwt
    {
        ...
        /// <returns></returns>
        public string CreateJwtToken(IdentityUser new_User,List<Claim>input_claims)
        {
            var claims = new List<System.Security.Claims.Claim>
            {
            new System.Security.Claims.Claim(JwtRegisteredClaimNames.Sub, new_User.Id.ToString()),
            new System.Security.Claims.Claim(JwtRegisteredClaimNames.UniqueName, new_User.UserName),
            new System.Security.Claims.Claim(JwtRegisteredClaimNames.Jti,Guid.NewGuid().ToString()),
            };

            var roleClaims = input_claims.Select(c => new System.Security.Claims.Claim(c.Type, c.Value));
            ...
            JwtSecurityToken tokengenerator = new JwtSecurityToken(
               ...
               expires: DateTime.Now.AddMinutes(int.Parse(_configuration["JWT:Expiration_Time"])),
               claims: claims,
